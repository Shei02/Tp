...
public class Plataforma {
    ...
    private void inicializar() {
        Serie serie1 = new Serie("Breaking Bad", "zombie", "walter white", "suspenso");
    ...
    public float promedioSerie(String titulo) {
        for (Serie serie : series) {
            if (titulo == serie.getTitulo()) {
                return serie.promedioSerie();
            }
        }
        System.out.println("No se encontro la serie " + titulo + ".");
        return -1;
    }
}
